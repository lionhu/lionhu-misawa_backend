  ...
  mounted() {
    ...
    if (self.isSupplier) {
      orderService.get_status_count({
        ...
        info: {
          supplier_id: self.ME.supplier.id,
        }
...
<template>
  <div class="card">
    <div class="card-body">
      <a href="/supplier/orders" class="p-0 float-right mb-3">{{ $t("menuitems.supplier.list.orders") }} <i class="mdi mdi-download ml-1"></i></a>
      <h4 class="header-title mt-1">Status Orders</h4>
