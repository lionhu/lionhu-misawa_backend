      ...
      <div class="row">
        <div class="col-lg-12">
          <el-upload
            ...
            :action="'http://misawa-pharmacy.nichiei.services/daphne/api/store/public/products/'+product.id+'/update_post_image/'"
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="row justify-content-start">
            <div class="col-xl-8">
              <el-upload
                :action="'http://misawa-pharmacy.nichiei.services/daphne/api/store/public/sliderimages/'"
