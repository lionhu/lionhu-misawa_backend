          ...
          <div class="card-body">
            ...
            <div class="row mb-2">
              <div class="col-sm-6">
                <el-tree
                  ...
                  <span>{{ node.label }}</span>
                    <span class="badge badge-pill badge-danger" v-if="data.regular_product_count">{{data.regular_product_count}}</span>
              ...
              <div class="col-sm-6" v-if="mode==='edit' ||mode==='add'">
                ...
                <b-form-group id="fieldset-valid" label-cols="4" label-cols-lg="2" label-size="sm" label="Valid">
                  <switches v-model="menuitem.is_valid" id="valid" theme="bootstrap" color="warning"
                ...
                <b-form-group id="fieldset-link" label-cols="4" label-cols-lg="2" label-size="sm" label="Access">
                  <b-form-checkbox v-model="menuitem.access.superadmin" name="check-button" switch>Superadmin</b-form-checkbox>
                  <b-form-checkbox v-model="menuitem.access.supplier" name="check-button" switch>supplier</b-form-checkbox>
                  <b-form-checkbox v-model="menuitem.access.client_admin" name="check-button" switch>Client</b-form-checkbox>
                  <b-form-checkbox v-model="menuitem.access.member" name="check-button" switch>Member</b-form-checkbox>
                </b-form-group>
