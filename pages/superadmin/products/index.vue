          ...
          <div class="card-body">
            <el-tree
              ...
              <span class="custom-tree-node" slot-scope="{ node, data }">
                ...
                <span class="badge badge-pill badge-danger float-right" v-if="data.regular_product_count">{{data.regular_product_count}}</span>
              </span>
            </el-tree>
          </div>
        </div>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive mb-0" v-if="productlist_meta.total">
              <el-table
                :data="productlist"
                style="width: 100%">
                <el-table-column width="450" label="Product" sortable prop="id">
                  <template slot-scope="scope">
                    <div v-if="scope.row.thumbimage_url">
                      ...
                      <img :src="scope.row.thumbimage_url" alt=""
                           class="rounded mr-3" style="max-width:240px;"/>
                        </a>
                    </div>
                    ...
                    <h6 class="m-0 d-inline-block align-middle">
                      {{ scope.row.item_name }}(#{{ scope.row.id }}) <br>
                      {{ scope.row.item_name_zh }}
                    </h6>
                  </template>
                </el-table-column>
                <el-table-column
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    <ul class="list-inline table-action m-0">
                      ...
                      <li class="list-inline-item">
                        <a href="javascript:void(0);" @click="deleteProduct(scope.row.id)">
