...
export default {
  ...
  methods: {
    ...
    post_image_action_url(product_id){
      return `${this.$config.lionhu_baseURL}/store/public/products/${product_id}/update_post_image/`
    },
    slider_image_action_url(){
      return `${this.$config.lionhu_baseURL}/store/public/sliderimages/`
    },
      ...
      <div class="row">
        <div class="col-lg-12">
          <el-upload
            ...
            :action="post_image_action_url(product.id)"
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="row justify-content-start">
            <div class="col-xl-8">
              <el-upload
                :action="slider_image_action_url()"
